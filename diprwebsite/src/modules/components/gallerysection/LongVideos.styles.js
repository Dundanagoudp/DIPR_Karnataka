...
export const VideoPlayerSection = styled.div`
  ...
  height: fit-content;  // Changed from calc(100vh - ${theme.spacing(2)})
  display: flex;
  flex-direction: column;
...
export const VideoItem = styled.div.attrs((props) => ({
  ...
  background-color: ${(props) => (props.$isActive ? theme.colors.bggrey : "transparent")};
...
// Comment Section Styled Components

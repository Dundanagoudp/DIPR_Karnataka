...
// New components for likes and comments
...
export const LikeButton = styled.button`
  ...
  justify-content: center;
  cursor: pointer;
  color: ${(props) => (props.isLiked ? "#ff0000" : "white")};
  transition: all 0.3s ease;
...
export const CommentSection = styled.div`
  ...
  max-height: 70%;
  background-color: rgba(0, 0, 0, 0.8);
  border-top-left-radius: ${theme.spacing(1.5)};
  border-top-right-radius: ${theme.spacing(1.5)};
